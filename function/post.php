    ...
    <script>
        ...
        $(document).ready(function() {
            $("#cmt-btn").click(function() {
                $("#cmt-btn").removeClass("btn-secondary");
                $("#cmt-btn").addClass("btn-primary");
                $("#comment").load(url + "themes/comment.php?post_id=<?php echo $post_id; ?>");
            });
...
<body>
    ...
    <main class="container">
        ...
        ?>
        <button type="button" class="btn btn-secondary" id="cmt-btn">
