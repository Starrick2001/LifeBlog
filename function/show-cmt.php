...
<body>
    ...
    ?>
        <div class="row pb-2 m-2">
            <div class="col-1 p-0">
                <a href="<?php echo $url . "themes/profile.php?profile_email=" . $comment["author"] ?>"><img src="<?php echo $link . $comment["avatarUrl"] ?>" class="w-100"></a>
            </div>
            <div class="col-11">
                <div class="row">
                        ...
                        if ($result_cmt_like->num_rows > 0) {
                            ...
                            ?>
                                ...
                                ?>
                                    ...
                                    <button class="btn btn-success m-1 edit-cmt-btn" cmt_id=<?php echo $comment["cmt_id"] ?>>
