...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2021 at 06:54 AM
...
VALUES
  ...
  (
    ...
    0,
    12,
    'Đậm chất ngôn tình, sâu sắc như truyện ngôn tình TQ',
    'lebuidihoa257@gmail.com',
    '2021-06-30 06:08:14'
  ),
  (
    ...
    2,
    12,
    'nếu trong túi có tiền thì tự nhiên hạnh phúc.',
    'lebuidihoa257@gmail.com',
    '2021-06-30 06:08:36'
  ),
  (
...
VALUES
  (
    'bancuaHoaLe@Wibunetwork.com',
    'Ngô Hải',
    'img/Logo/Logo1.png',
    '2001-08-03',
    '74fc46011350386f05c94c9b48633ae7'
  ),
  (
    'Baoquoccle@gmail.com',
    'Lê Quốc Bảo',
    'img/Logo/Logo1.png',
    '2001-05-19',
    '68fe8f2aa739126f5df2c6e556f800ae'
  ),
  (
    'dbrr@gmail.com',
    'VL nuôn',
    'img/Logo/Logo1.png',
    '2021-07-13',
    '9d372c45762b35e645f110b9d4b56029'
  ),
  (
    'hieubui12345@gmail.com',
    'Hiếu Bùi',
    'img/Logo/Logo1.png',
    '2001-09-09',
  ...
  (
    'hoale@gmail.com',
    'Hoà Lê',
    'img/avatar/190250767_326495498846741_8932439268743606007_n.jpg',
    '2021-06-21',
  ...
  (
    ...
    'img/Logo/Logo1.png',
    '2001-05-03',
    '5ab434881fffb9ad3fc061997aae8f51'
  ),
  (
    'nhuhuynhpham2001@gmail.com',
    'Huỳnh Như',
    'img/Logo/Logo1.png',
    '2001-08-11',
    'd0b656889d677ccd2bff8e3c40f05242'
  );
...
VALUES
  ...
  (
    ...
    '<p>Có những người mình nhớ họ, nhưng mình cũng đã bỏ lỡ họ rồi. Dù mình vẫn còn xót xa, nuối tiếc nhưng việc níu giữ những mối quan hệ đã đi đến hồi kết có khác gì tiếp tục tưới nước cho một chậu cây đã héo úa đâu?</p><p>Đừng vì miss - nỗi nhớ cho một điều gì đó đã qua khiến bạn miss - bỏ lỡ những điều tuyệt vời hơn thế đang chờ đợi nhé. Hãy tập trung vào hiện tại, vào những người đang ở bên bạn. Bởi lẽ điều tuyệt vời nhất không phải ở quá khứ hay tương lai mà nằm trong chính khoảnh khắc hiện tại đó bạn à.</p>',
    'Lê Bùi Dĩ Hoà - lebuidihoa257@gmail.com',
    '2021-06-15 12:47:37'
  ),
  (
  ...
  (
    20,
    'Tình cảm',
    'img/205338753_330035178676698_5836509305794724829_n.png',
    '<p>Tình cảm phải trải qua nhiều nấc để chạm tới hạnh phúc mĩ mãn.</p><p>Nấc đầu tiên chính là:</p><p>\"Tớ hic cậu\".</p>',
    'Lê Bùi Dĩ Hoà - lebuidihoa257@gmail.com',
    '2021-07-01 06:32:01'
  );
...
ALTER TABLE
  `post_like`
ADD
  CONSTRAINT `post_like_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`);
