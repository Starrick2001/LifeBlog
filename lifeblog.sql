...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2021 at 06:54 PM
...
(11, 0, 5, 'check', 'nhuhuynhpham2001@gmail.com', '2021-07-02 10:11:28');
...
(7, 'Miss trong tiếng anh là nhớ, nhưng miss cũng là bỏ lỡ', 'img/193035562_591199938950133_8131373737949004407_n.jpg', '<p>Có những người mình nhớ họ, nhưng mình cũng đã bỏ lỡ họ rồi. Dù mình vẫn còn xót xa, nuối tiếc nhưng việc níu giữ những mối quan hệ đã đi đến hồi kết có khác gì tiếp tục tưới nước cho một chậu cây đã héo úa đâu?</p><p>Đừng vì miss - nỗi nhớ cho một điều gì đó đã qua khiến bạn miss - bỏ lỡ những điều tuyệt vời hơn thế đang chờ đợi nhé. Hãy tập trung vào hiện tại, vào những người đang ở bên bạn. Bởi lẽ điều tuyệt vời nhất không phải ở quá khứ hay tương lai mà nằm trong chính khoảnh khắc hiện tại đó bạn à.</p><p>Mắt toét</p>', '2021-06-15 12:47:37', 'lebuidihoa257@gmail.com', 'Lê Bùi Dĩ Hoà '),
...
(9, 'LỪA MÌNH DỐI NGƯỜI', 'img/inbound2125792141157892209.jpg', '<p>Bám theo những sai lầm, miệng bảo sẽ ổn thôi. Nhưng có thật sự ổn không?</p>', '2021-07-02 14:24:01', 'nhuhuynhpham2001@gmail.com', 'Huỳnh Như'),
(10, 'Test', 'img/logo/Logo2.png', '<p><i><strong>Nội dung đó</strong></i></p>', '2021-06-23 04:19:37', 'hieubui12345@gmail.com', 'Hiếu Bùi'),
(11, 'Test', 'img/logo/Logo2.png', '<p>Nội dung</p>', '2021-06-23 03:55:47', 'hieubui12345@gmail.com', 'Hiếu Bùi'),
...
(19, '123', 'img/logo/Logo2.png', '<p>123</p>', '2021-07-01 06:22:51', 'lebuidihoa257@gmail.com', 'Lê Bùi Dĩ Hoà ');
...
--
ALTER TABLE `notification`
  MODIFY `noti_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
